...
export default function Dashboard(){
 ...
 return <main className="shell">
  ...
  <header className="header"><div><h1>Reseller Hub</h1><p>Track every item from purchase through photos, listing and final disposition.</p></div><div className="actions"><a className="button secondary" href="/inventory/bulk-entry">Quick Add</a><a className="button" href="/inventory">Open Inventory</a></div></header>
