...
export default function Dashboard(){
 ...
 return <main className="shell">
  <nav className="globalNav"><a href="/">Dashboard</a><a href="/inventory">Inventory</a><a href="/inventory/spreadsheet">Spreadsheet View</a><a href="/listings">Listed</a><a href="/sales">Sold</a><a href="/gmail">Sales Sync</a><a href="/nifty">Nifty</a></nav>
  <header className="header"><div><h1>Reseller Hub</h1><p>Track every item from purchase through photos, listing and final disposition.</p></div><div className="actions"><a className="button secondary" href="/inventory/bulk-entry">Quick Add</a><a className="button secondary" href="/gmail">Sales Sync</a><a className="button secondary" href="/nifty">Connect Nifty</a><a className="button" href="/inventory">Open Inventory</a></div></header>
